...
public class AccountController {
	...
	@PostMapping("/update")
	public String memberModify(HttpSession session, @ModelAttribute("MemberVo") @Valid MemberVO memberVo, BindingResult result, Model m) {
		MemberDto loginMember = (MemberDto)session.getAttribute("loginMember");
		MemberDto changeMember = new MemberDto(memberVo.getMemberId(), memberVo.getPassword(), 
