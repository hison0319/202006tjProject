...
public class WordbookService {
	...
	// 소유 단어장 조회(전체 체크)
	public List<WordbookDto> selectWordbookByOwnerIdCheck(int id) throws Exception {
		return wordbookMapper.selectWordbookByOwnerIdCheck(id);
	}

	// 소유 단어장 조회(전체 체크)
	public List<WordbookDto> selectWordbookByOwnerIdOrGuestIdCheck(int id) throws Exception {
		return wordbookMapper.selectWordbookByOwnerIdOrGuestIdCheck(id);
	}
