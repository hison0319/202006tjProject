			...
			<form name="signupForm" action="insert" method="post">
				<div class="row gtr-uniform">
					<div class="col-6 col-12-xsmall">
						...
						<span class="error_next_box" id="idMsg" aria-live="assertive">필수 정보입니다.</span>
						...
						<span class="error_next_box" id="pwMsg" aria-live="assertive">필수 정보입니다.</span>
						<br>
						...
						<span class="error_next_box" id="pwCheckMsg" aria-live="assertive">필수 정보입니다.</span>
						<br>

						<div class="signup_email">
							이메일 <br> <input type="email" id="email" name="email"
								value="${member.email}" placeholder="">
							<c:if test="${eemail != null}">
								<p style="color: red">이메일 형식에 맞지 않습니다.</p>
							</c:if>
						</div>
						<span class="error_next_box" id="emailMsg" aria-live="assertive">필수 정보입니다.</span>
						...
						<div class="signup_phone">
							휴대폰 번호 <br> <input type="text" id="phone" name="phone" maxlength="11"
								value="${member.phone}" placeholder="- 제외 숫자만 입력해주세요.">
							<c:if test="${ephone != null}">
								<p style="color: red">전화번호 형식에 맞지 않습니다.</p>
							</c:if>
						</div>
						<span class="error_next_box" id="phoneMsg" aria-live="assertive">필수 정보입니다.</span>
						...
						<div class="signup_addr">
							주소 <br> <input type="text" id="address" name="address"
								value="${member.address}" placeholder="">
						</div>
						<br>

						<div class="signup_btn_box actions stacked">
							<input type="submit" style="width:100%;" value="회원가입" class="button primary fit">
						</div>
					</div>
				</div>
			</form>
